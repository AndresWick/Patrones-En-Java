...
public class Prueba_Patron_Bridge {
	public static int preguntarFormaContacto(){
		int i=Integer.parseInt(JOptionPane.showInputDialog("Seleccione la
		 forma de contacto que desee: "
	...
	public static void main(String[] args) {
		...
		int opcionContacto;
		opcionDependencia=Integer.parseInt(JOptionPane.showInputDialog("Seleccione la
		 dependencia que desea consultar: "
